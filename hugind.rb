class Hugind < Formula
  ...
  url "https://github.com/netdur/hugind/releases/download/v0.9.1/hugind-macos-arm64.tar.gz"
  # REPLACE THE SHA BELOW with the one generated in Step 1
  sha256 "9ea834a9e57be9970559442a848a33310a69c5cacc873ee15cd9c1548612c65f"
  version "0.9.1"
